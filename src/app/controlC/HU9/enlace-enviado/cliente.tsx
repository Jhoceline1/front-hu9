...
export default function EnlaceEnviadoClient() {
  ...
  useEffect(() => {
    ...
    const key = `servineo_last_request_${email}`;
  ...
  const handleResend = async () => {
    ...
    const fallback = setTimeout(
      () => setInfo('Estamos tardando más de lo normal…'),
      3000
    );
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-servineo-500 via-servineo-300 to-servineo-400 p-6">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border border-servineo-100">
        ...
        <div className="p-8">
          ...
          <div className="mt-5 flex flex-col items-center gap-2" aria-live="polite">
            <p className="text-sm text-gray-700">Tiempo restante:</p>
            <div className="px-6 py-2 rounded-full bg-gray-100 ring-1 ring-gray-300 text-3xl font-semibold text-gray-900 tracking-widest tabular-nums shadow-sm">
          ...
          <div className="mt-6 text-xs text-gray-600 space-y-1">
            <p>• Revisa la carpeta de <span className="font-medium">Spam</span> o <span className="font-medium">Promociones</span>.</p>
